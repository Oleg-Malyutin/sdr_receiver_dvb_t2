...
public:
    ...
    ~p1_symbol();
    bool execute(const int _len_in, complex* _sample, int &_idx_consume, complex* _buffer_sym, int &_idx_sym,
                 dvbt2_parameters &_dvbt2, float &_coarse_freq_offset, bool &_decoded);
signals:
