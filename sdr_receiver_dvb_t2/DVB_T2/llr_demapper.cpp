...
llr_demapper::llr_demapper(QWaitCondition *_signal_in, QMutex* _mutex, QObject* parent) :
    ...
    mutex_in(_mutex)
{
    derotate_qpsk.real(cosf(-ROT_QPSK));
    derotate_qpsk.imag(sinf(-ROT_QPSK));
    derotate_qam16.real(cosf(-ROT_QAM16));
    derotate_qam16.imag(sinf(-ROT_QAM16));
    derotate_qam64.real(cosf(-ROT_QAM64));
    derotate_qam64.imag(sinf(-ROT_QAM64));
    derotate_qam256.real(cosf(-ROT_QAM256));
    derotate_qam256.imag(sinf(-ROT_QAM256));
...
void llr_demapper::qam16(int _plp_id, l1_postsignalling _l1_post, int _len_in, complex* _in)
{
    ...
    float precision;
    float llr_bits_0_1[8] __attribute__((aligned(32)));
    float llr_bits_2_3[8] __attribute__((aligned(32)));
...
void llr_demapper::qam64(int _plp_id, l1_postsignalling _l1_post, int _len_in, complex* _in)
{
    ...
    float llr_bits_0_1[8] __attribute__((aligned(32)));
    float llr_bits_2_3[8] __attribute__((aligned(32)));
    float llr_bits_4_5[8] __attribute__((aligned(32)));
...
void llr_demapper::qam256(int _plp_id, l1_postsignalling _l1_post, int _len_in, complex* _in)
{
    ...
    float llr_bits_2_3[8] __attribute__((aligned(32)));
    float llr_bits_4_5[8] __attribute__((aligned(32)));
    float llr_bits_6_7[8] __attribute__((aligned(32)));
